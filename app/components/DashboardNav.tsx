...
const sections = [
  { id: 'marketing-roi', label: 'Marketing ROI', icon: TrendingUp, href: '/dashboard/marketing-roi' },
  { id: 'lead-quality', label: 'Lead Quality Analytics', icon: Search, href: '/dashboard/lead-quality' },
  { id: 'sales-pipeline', label: 'Sales Pipeline', icon: Zap, href: '/dashboard/sales-pipeline' },
  { id: 'partner-performance', label: 'Partner Performance', icon: Users, href: '/dashboard/partner-performance' },
  { id: 'client-lifetime-value', label: 'Client Lifetime Value', icon: Gem, href: '/dashboard/client-lifetime-value' },
]
